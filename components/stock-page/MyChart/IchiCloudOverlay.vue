...
export default {
    ...
    methods: {
        ...
        legend(values) {
            ...
            return [
                { value: "Tenkan: " + xs[0], color: this.tenkan_color},
                { value: "Kijun: " + xs[1], color: this.kijun_color},
                { value: "SpanA: " + xs[2], color: this.senkou_spanA_color},
                { value: "SpanB: " + xs[2], color: this.senkou_spanB_color},
                { value: "Chinkou: " + xs[2], color: this.chinkou_color},
            ]
        }
    },
};
