  ...
  methods: {
    meta_info() {
      return {
        author: "Flibyrd",
        version: "1.0.0",
        desc: "Positive & Negative Mentions on Social Media",
        preset: {
          name: "SocialMentions",
          side: "offchart",
          settings: {
    ...
    legend(values) {
      ...
      return [
        { value: "Positive Mentions: " + Math.abs(xs[0]), color: this.pos_color },
        { value: "Negative Mentions: " + Math.abs(xs[1]), color: this.neg_color },
      ];
    },
  },
