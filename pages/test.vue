...
<script>
// OVERLAY OPTIONS (TYPE OF CHARTS): Candles, Volume, Spline, Splines, Channel, Range, Trades, Segment, Splitters
import TradingVue from 'trading-vue-js'
import { DataCube } from 'trading-vue-js' 
import smaCalc from '~/assets/technicals'
import TestOverlay from '~/components/TestOverlay' 

export default {
    components: {TradingVue, SMA},
 //   props: ['width', 'height'], // Props generated by the TVJS engine
    ...
    "onchart": [{
        ...
        "data": [
            ...
            [1556031600000, "Hindsight 🦆", 1, "#f4c20d", 0.75],
            [1555344000000, "20/20 😎", 1, "#777", 0.65]
        ],
        "settings": {
            "legend": true
        }
    ...
    methods: {
      async fixChart() {
        ...
        async getData() {
            ...
            const techn = smaCalc(8, stockData)
